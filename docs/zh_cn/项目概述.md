...
│   │       └── task_hud_recognizer.py # HUD任务识别器
│   ├── utils/                # 通用工具模块
│   │   ├── __init__.py
│   │   └── logger.py
...
| 文档名称 | 用途 | 路径 | 重要性 |
|---------|------|------|--------|
| 任务流水线协议 | 编写 JSON 格式的 node 任务 | `docs/maafw_doc/zh_cn/3.1-任务流水线协议.md` | **必须学习** |
| ProjectInterfaceV2 协议 | 编写外部 interface 接口 | `docs/maafw_doc/zh_cn/3.3-ProjectInterfaceV2协议.md` | **必须学习** |
| 快速开始 | MAAFW 快速入门指南 | `docs/maafw_doc/zh_cn/1.1-快速开始.md` | 推荐学习 |
| 术语解释 | MAAFW 核心术语说明 | `docs/maafw_doc/zh_cn/1.2-术语解释.md` | 推荐学习 |
